  ...
  return (
          ...
          <ul className='flex gap-4'>
            {
              navlinks.map((v, i) => {
                ...
                return (
                  <>
                      <li className='px-6 py-1 text-xl text-[#fff] font-semibold'><Link className='hvr' href={v.href}>{v.lable}</Link></li>
    ...
    <div className='flex justify-center gap-20 mb-10 max-h-[8vh]'>
        <div>
            ...
            <ul className={`${navbar ? 'visible h-[270px] transition-all duration-500 opacity-90 border shadow-2xl' : 'invisible h-0 transition-all duration-500 opacity-0'} leading-[2.25rem] w-[18vw] text-base p-4 font-semibold bg-[#ffffff] relative text-gray-500`}>
        ...
        <div>
            <div className='flex justify-center hover:cursor-pointer'>
              ...
              <div>
                ...
                <ul className={`${find ? 'visible h-[330px] transition-all duration-500 opacity-100 border shadow-2xl' : 'invisible h-0 transition-all duration-500 opacity-0'} leading-[2.25rem] w-[28vw] text-base font-medium text-gray-500 relative bg-[#fff]`}>
